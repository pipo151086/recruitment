using MIMJWT = Microsoft.IdentityModel.JsonWebTokens;
...
namespace Api.Core.Auth.Jwt
{
    public class JwtHandler : IJwtHandler
    {
        ...
        public CusJsonWebToken CreateToken(string userId, string role = null, IDictionary<string, string> claims = null)
        {
        ...
        public CusJsonWebTokenPayload GetTokenPayload(string accessToken)
        {
            ...
            return new CusJsonWebTokenPayload
            {
                Subject = jwt.Subject,
